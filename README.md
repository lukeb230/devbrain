...
- **Web + Console** (Next.js) — sign-in, invites and repo linking in the browser; the Console (rendered inside the Mac app) has presence, PRs with merge traffic lights, tasks
...
- **Mac app** (Tauri) — a corner badge / menu-bar panel showing the live
  Console window, native notifications, and the installer for everything below.
