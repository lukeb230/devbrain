...
### For the team (the Mac app: panel + Console)
...
```
 ...
 │  └ DevBrain plugin            │ ────────▶  │  • Console pages (served to the app)│
