# DevBrain Terms of Use

**Effective: [EFFECTIVE DATE]**

These Terms of Use ("Terms") are an agreement between you and the operator of DevBrain, a sole proprietorship trading as DevBrain ("DevBrain", "we", "us"). The operator's legal name and address are available on request at [EMAIL]. They cover the DevBrain website at [DOMAIN], the DevBrain macOS application, the DevBrain command-line tool and agent plugins, the DevBrain GitHub App, and every related service (together, the "Service").

By downloading the app, signing in, installing the plugin, or using any part of the Service, you agree to these Terms and to our Privacy Policy at [DOMAIN]/privacy. If you are accepting on behalf of a company or another organisation, you confirm you have the authority to bind it, and "you" means that organisation as well as you personally. If you do not agree, do not use the Service.
...
Our source code is publicly viewable at github.com/lukeb230/devbrain. Being able to read it does not grant you a licence to it beyond what a licence file in that repository, if any, expressly says.
...
We may change, pause, limit, or discontinue any part of the Service at any time, including by imposing usage caps such as limits on AI-generated output. Because the Service is free and early, it comes with no uptime or support commitment.
...
You may stop using the Service at any time by revoking your device tokens, unlinking your repositories (which removes the GitHub App from them), leaving your teams, and deleting the app.

When a repository is unlinked, the presence, claims, and journal collection for it stop. When a team is removed, or on request from a team owner or admin, we delete the team's data, subject to the retention periods and backup cycles described in the Privacy Policy. If we discontinue the Service or end the beta, we will give you at least 30 days' notice where we can, during which you may ask for your team's data to be deleted; after that period we may delete it ourselves.

Sections 4 (restrictions), 5 (your content, to the extent needed to wind down), 7, 13, 14, 15, 17, and 18 survive the end of these Terms.
...
"DevBrain" and the DevBrain mark are our marks. Claude and Claude Code are trademarks of Anthropic. Cursor is a trademark of Anysphere. Codex and GitHub are trademarks of OpenAI and GitHub, Inc. DevBrain is not affiliated with, endorsed by, or sponsored by any of them.
...
These Terms are governed by the laws of [STATE / COUNTRY], without regard to conflict-of-law rules. Any dispute arising out of or relating to these Terms or the Service will be brought exclusively in the courts located in [COUNTY, STATE / CITY, COUNTRY], and you consent to their jurisdiction, except that either party may seek injunctive relief in any court of competent jurisdiction to protect its intellectual property.

Before starting any formal proceeding, you agree to contact us at [EMAIL] and give us 30 days to try to resolve the matter informally.
...
- **Contact.** DevBrain, [EMAIL]. Security reports: [SECURITY EMAIL or EMAIL].

---

*Placeholders to fill before publishing: [DOMAIN], [EMAIL], [SECURITY EMAIL], [STATE / COUNTRY], [COUNTY, STATE / CITY, COUNTRY], [EFFECTIVE DATE]. Update `LEGAL.operator`, `LEGAL.contact` and `LEGAL.effective` in `src/lib/legal.ts` to match. This draft is written in good faith for an early, free product and is not legal advice; have a lawyer review it before real teams rely on it.*
