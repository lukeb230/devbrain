...
const Eyebrow = ({ children }: { children: React.ReactNode }) => (
  <div className="font-mono text-[10.5px] uppercase tracking-[.14em] text-accent">{children}</div>
);
    ...
    <main className="pb-24">
      ...
      <Section className="flex items-center gap-5 py-5">
        ...
        <nav className="ml-auto flex items-center gap-5 text-[12.5px] text-muted">
          <a href="#how" className="hidden hover:text-txt sm:inline">How it works</a>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_440px] lg:gap-10">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <a href="#how" className="text-[13px] text-accent hover:underline">See how it works</a>
            </div>
            <p className="mt-4 font-mono text-[11.5px] leading-[1.7] text-faint">
      ...
      <Section className="pt-24 sm:pt-32">
        ...
        <figure className="mt-6 overflow-x-auto rounded-xl border border-[var(--wg-wait-line)] bg-[var(--wg-wait-bg)] px-5 py-4">
          <pre className="whitespace-pre-wrap font-mono text-[12.5px] leading-[1.7] text-wait">
...
deliberately.`}
          ...
          <figcaption className="mt-3 font-mono text-[10.5px] uppercase tracking-[.1em] text-faint">
            The actual warning, verbatim from the collision guard
          </figcaption>
        </figure>
      ...
      <Section className="pt-16">
        <footer className="flex flex-wrap items-center gap-4 border-t border-line pt-6 text-[12px] text-faint">
          <span>DevBrain</span>
          <Link href="/pricing" className="hover:text-txt">Pricing</Link>
