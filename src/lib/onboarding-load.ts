...
//
// Step 5 ("working") is "any evidence ever in a linked repo" — so sessions
// and activity are queried scoped to repoIds with limit(1), not the most
// recent N rows. A recency window would let 20+ newer rows in other repos
// push a real earlier hit out of view and flip the step back to incomplete.
